...
export default function Nav() {
  return (
    <header className="fixed top-0 z-50 w-[100vw] bg-[rgba(25,26,26,0.67)] text-white sm:px-10 px-2 sm:py-3 py-1 justify-center animate-caret-blink repeat-1">
      <div className="container mx-auto flex items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <button className="group bg-[#22282d] text-white font-bold sm:py-3 py-2 sm:px-6 px-3 rounded-4xl flex items-center space-x-2 hover:bg-white hover:text-black transition-all duration-500">
