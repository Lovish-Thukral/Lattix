...
const About = () => {
  ...
  return (
    <div>
      ...
      <section className="h-max w-[90%] mx-auto px-10 my-16 grid grid-cols-3 sm:grid-cols-8 gap-6">
        <motion.h3
          className="text-xl font-bold col-span-1 sm:col-span-2 "
      ...
      <div className="h-screen w-[90%] bg-[rgb(25,26,26)] flex-1 justify-center items-center px-16 pt-[10vh] bg-cover bg-no-repeat bg-center mx-auto my-20 rounded-[3rem]">
        ...
        <motion.h2
          ...
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
          className="text-3xl md:text-4xl font-bold mb-20 text-center md:text-left bebas-neue-regular font-stretch-125% "
        >
        ...
        <div className="flex flex-col gap-12 px-16">
          {values.map((val, i) => (
            ...
            >
              {/* Number + Title */}
              <div className="md:w-1/3 flex items-center gap-16">
